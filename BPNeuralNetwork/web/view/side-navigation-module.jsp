...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <ul id="slide-out" class="side-nav fixed">
        <li><div class="userView">
                <a href="#!user"><img id="user-image" class="circle" src="${pageContext.request.contextPath}/view/varutsongdaeng.jpg"></a>
                <div class="center">
                   <ul> 
                       <li><a id="name" href="#!name"><span class="white-text" >Varut Songdaeng</span></a></li>
                        <li><a id="email" href="#!email"><span class="white-text email">varut2-songdaeng@live.uwe.ac.uk</span></a></li>
                        <li><a href="#!email"><span class="white-text">Student Number: 16020413</span></a></li>
                    </ul>
                </div>
            </div>            
